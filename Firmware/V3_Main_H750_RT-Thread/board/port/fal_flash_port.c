...
#ifndef FAL_USING_NAND_FLASH_DEV_NAME
#define FAL_USING_NAND_FLASH_DEV_NAME             "nandflash0"
#endif
...
struct fal_flash_dev nand_flash0 =
{
    .name       = FAL_USING_NAND_FLASH_DEV_NAME,
    .addr       = 0,
    .len        = 128 * 1024 * 1024,
    .blk_size   = 2048,
